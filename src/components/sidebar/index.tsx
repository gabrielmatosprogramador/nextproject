...
export function Sidebar() {
  return (
    <div className="flex w-full flex-col">
        ...
        bg-background hidden sm:flex flex-col">
        ...
        <div className="flex flex-col sm:gap-4 sm:py-4 sm-pl-4">
            <header className="sticky top-0 z-30 flex h-14 items-center px-4 border-b bg-background gap-4 sm:static sm:h-auto sm:border-0 sm:bg-transparent dm:px-6">
                <Sheet>
